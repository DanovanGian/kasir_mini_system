...
public class MenuKasir {
    ...
    private void tampilKeranjang(Transaksi trx) {
        if (trx.getDetailList().isEmpty()) {
            ...
            trx.getDetailList().forEach(d -> System.out.printf("%-20s %3dx %-10.0f = %10.0f%n",
    ...
    private void bayar(Transaksi trx) {
        ...
        trx.getDetailList().forEach(d -> d.getBarang().kurangiStok(d.getJumlah()));
