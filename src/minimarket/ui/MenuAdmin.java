...
public class MenuAdmin {
    ...
    public MenuAdmin(User admin) { this.admin = admin; }
    ...
    private void lihatBarang() {
        ...
        if (list.isEmpty()) { System.out.println("Belum ada barang."); return; }
    ...
    private void hapusBarang() {
        ...
        if (barangRepo.hapus(kode)) System.out.println("Barang dihapus!");
    ...
    private void cariBarang() {
        ...
        if (hasil.isEmpty()) System.out.println("Barang tidak ditemukan.");
        else hasil.forEach(b -> System.out.println(b.getInfo()));
    }
}